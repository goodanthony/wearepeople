...
--
-- Name: solid_cache_tables; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.solid_cache_tables (
    id bigint NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: solid_cache_tables_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.solid_cache_tables_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: solid_cache_tables_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.solid_cache_tables_id_seq OWNED BY public.solid_cache_tables.id;
...
--
-- Name: solid_cache_tables id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.solid_cache_tables ALTER COLUMN id SET DEFAULT nextval('public.solid_cache_tables_id_seq'::regclass);
...
--
-- Name: solid_cache_tables solid_cache_tables_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.solid_cache_tables
    ADD CONSTRAINT solid_cache_tables_pkey PRIMARY KEY (id);
